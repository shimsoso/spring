		...
		<div>
			<form>
				<div class="row mb-2"><!-- 12기억할것!! -->
					...
					<div class="col">
						<input type="text" name="keyword" class="form-select form-select-sm" value="${pager.keyword}">
					</div>
					<div class="col-1 d-grid">
						<button class="btn btm-sm btn-primary">검색</button>
					</div>
				</div>
			</form>
		</div>
